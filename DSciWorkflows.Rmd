...
The RSpark developmentenvironment:  
RSpark: [https://github.com/jharner/rspark](https://github.com/jharner/rspark)

A user environment pulled from Docker Hub:  
RSpark Docker: [https://github.com/jharner/rsparkdocker](https://github.com/jharner/rsparkdocker)

A user environment pulled from Vagrant Cloud:  
RSpark Vagrant: [https://github.com/jharner/rspark-vagrant](https://github.com/jharner/rsparkdocker)
...
The tuorial content is based on [RSpark Tutorial](https://github.com/jharner/rspark-tutorial)

Note: a number of the sections will only be partially covered.

* Session 1:  
  + Module 1 Fundamentals: s1 workflows; s3 linux; s4 git; s5 data structure; s6 functions; s7 intro machine learning (ml)    
  + Module 2: s1 text; s5 databases s7 excel 
